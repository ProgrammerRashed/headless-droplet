...
function VideoListCard() {
  return (
    <div className="mb-[10px] cursor-pointer border-gray pb-[10px] last-of-type:mb-0 last-of-type:border-none lg:border-b">
      <div className="hover:border-dark-light flex flex-row items-center gap-5 rounded-[4px] border-2 border-transparent p-2 transition-all duration-300 hover:bg-surface">
        <div className="relative md:h-[80px] md:min-w-[120px] lg:h-[99px] lg:min-w-[160px]">
          ...
          />
          <div className="absolute left-1/2 top-1/2 z-10 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center overflow-hidden rounded-full p-[14px] backdrop-blur-sm">
            <svg
              className="h-3 w-3"
