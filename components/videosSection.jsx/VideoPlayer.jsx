...
function VideoPlayer({ video }) {
  ...
  return (
    <div
      data-aos="fade-up"
      className="aspect-[330/186] w-full flex-grow overflow-hidden rounded-[8px] shadow-xl transition-all duration-300 hover:shadow-2xl md:aspect-auto md:h-[482px] lg:h-auto"
    >
      {isPlaying ? (
        <video
